...
def main():
    ...
    esm_model = ESMSequenceModel(seq_config)
    print("Initialized Sequence model!!")
    peptide_reps, mhc_reps = esm_model(batch['peptide_sequence'], batch['mhc_sequence'])
